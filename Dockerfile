...
RUN curl --insecure --silent https://nodejs.org/dist/v10.16.0/node-v10.16.0-linux-x64.tar.xz | xz -d | tar x -C /usr/local
RUN ln -s --directory -v /usr/local/node-v10.16.0-linux-x64 /usr/local/nodejs
